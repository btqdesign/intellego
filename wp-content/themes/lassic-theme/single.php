                ...
                <div class="<?php echo esc_attr($cs_layout); ?>"> 
                    ...
                    <div class="cs-post-panel">
                        ...
                        <ul class="cs-post-options">
							...
							POST ID:<?=$post->ID;?>
                            <li><i class=" icon-calendar11"></i><time datetime="<?php echo date_i18n('Y-m-d',strtotime(get_the_date('',$post->ID)));?>">
								!--<?php echo date_i18n('Y-m-d',strtotime(get_the_date('',$post->ID)));?>--!
                                <?php echo date_i18n('F d,Y',strtotime(get_the_date('',$post->ID)));?></time>
                            </li>
