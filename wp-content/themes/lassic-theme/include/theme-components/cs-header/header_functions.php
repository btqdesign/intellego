              ...
              <div class="modal-body">
                <div class="cssearch">
                        <form id="searchform" method="get" action="<?php echo home_url()?>"  role="search"> 
                            <input type="text" name="s" id="searchinput" value="<?php _e('Enter your search','lassic'); ?>" onblur="if(this.value == '') { this.value ='<?php _e('Escribe una palabra','lassic'); ?>'; }" onfocus="if(this.value =='<?php _e('Enter your search','lassic'); ?>') { this.value = ''; }"  >
